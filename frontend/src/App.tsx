...
function App() {
  ...
  const onHover = (event: any) => {
    ...
    tooltipRef.current.innerHTML = hoveredFeature.sourceLayer;
  };
    ...
    <>
      ...
      >
        ...
        <div ref={tooltipRef} className="tooltip">
          tooltip
          {/* <div>State: {hoverInfo.current.feature.properties.name}</div>
          <div>Class: {hoverInfo.current.feature.properties.class}</div>
          <div>Type: {hoverInfo.current.feature.properties.type}</div> */}
        </div>
      </Map>
    </>
  );
